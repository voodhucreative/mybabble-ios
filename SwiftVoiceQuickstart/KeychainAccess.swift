...
//
//  Created by Ford Walton on 02/12/2020.
...
public class KeychainService: NSObject {
    ...
    class func removeToken(service: String, account:String) {
    ...
    class func saveToken(service: String, account:String, data: String) {
    ...
    class func loadToken(service: String, account:String) -> String? {
        // Instantiate a new default keychain query
